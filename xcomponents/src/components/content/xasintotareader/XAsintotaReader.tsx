...
import styles from "./XAsintotaReader.module.css";
...
const BUILTIN_SECTION_NAMES: Record<string, string[]> = {
  es: ["CURVA", "PLANO CARTESIANO", "RECTA"],
  en: ["CURVE", "CARTESIAN PLANE", "LINE"],
  de: ["KURVE", "KARTESISCHES KOORDINATENSYSTEM", "GERADE"],
};
...
export type XAsintotaReaderProps = {
  rawText: string;
  coverImage?: string;
  locale?: string;
...
export function XAsintotaReader({
  rawText,
  coverImage,
  locale = "es",
  labels,
